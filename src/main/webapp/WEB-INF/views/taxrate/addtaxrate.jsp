				...
				<div>
					...
					<c:forEach items="${sessionScope.newModuleList}" var="modules">
						<c:forEach items="${modules.subModuleJsonList}" var="subModule">
							...
							<c:choose>
								<c:when test="${subModule.subModuleMapping eq 'showAddTaxRate'}">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="box">
						<div class="box-title">
							<h3>
								<i class="fa fa-bars"></i> Add Tax Rate
							</h3>
							<div class="box-tool">

								<a href="${pageContext.request.contextPath}/taxRateList">Back
						...
						<div class="box-content">
							<form action="${pageContext.request.contextPath}/addTaxRateForSubCatId" class="form-horizontal"
								...
								<div class="form-group">
									<label class="col-sm-3 col-lg-2 control-label">Item
										Unit</label>
									<div class="col-sm-9 col-lg-10 controls">
										<select data-placeholder="Select UOM" name="uom"
											class="form-control chosen" tabindex="-1" id="selS0V"
											data-rule-required="true">
											<c:forEach items="${rmUomList}" var="uom" varStatus="count">
												<option value=""> </option>
												<option value="${uom.uomId}">${uom.uom} </option>
											</c:forEach>
								...
								<div class="form-group">
									<label class="col-sm-3 col-lg-2 control-label">Hsn Code
									</label>
									<div class="col-sm-9 col-lg-10 controls">
								...
								<div class="form-group">
									<label class="col-sm-3 col-lg-2 control-label">CGST Per
										Rate</label>
									<div class="col-sm-9 col-lg-10 controls">
								...
								<div class="form-group">
									<label class="col-sm-3 col-lg-2 control-label">SGST Per</label>
									<div class="col-sm-9 col-lg-10 controls">
								...
								<div class="form-group">
									<label class="col-sm-3 col-lg-2 control-label">IGST Per
									</label>
									<div class="col-sm-9 col-lg-10 controls">
