				...
				<div class="col-md-12">
					<div class="box">
						...
						<div class="box-content">
							<form
								action="${pageContext.request.contextPath}/addItemDepartment"
								...
								<div class="form-group">
									...
									<div class="col-sm-6 col-lg-4 controls">
										<input type="text" name="dept" id="dept" class="form-control"
											placeholder="Department Name" data-rule-required="true" value="${dept.deptName}" />
									</div>
											...
											<table id="table2" class="table table-advance">
												<thead>
													<tr class="bgpink">
														...
														<th width="360" align="center">Department</th>
												...
												<tbody>
													<c:forEach items="${deptList}" var="dept" varStatus="count">
														<tr>
															...
															<td align="left"><c:out value="${dept.deptName}"></c:out></td>

															<td align="left"><a title="Edit"
																href="updateItemDepartment/${dept.deptId}"><span
																	class="glyphicon glyphicon-edit"></span></a>&nbsp; <a
																title="Delete"
																href="deleteItemDepartment/${dept.deptId}"
