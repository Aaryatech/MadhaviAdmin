...
<jsp:include page="/WEB-INF/views/include/logout.jsp"></jsp:include>
	...
	<c:url var="materialRecieptMonthReport" value="/materialRecieptMonthReport"></c:url> 
	...
	<div class="container" id="main-container">
		...
		<div id="main-content">
			...
			<div class="page-title">
				<div>
					<h1>
						<i class="fa fa-file-o"></i>Inward Report Month Wise
					</h1>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="box" id="billwise">
						<div class="box-title">
							<h3>
								<i class="fa fa-table"></i>Inward Report Month Wise
							</h3>
							<div class="box-tool">
						...
						<div class="form-group">
								...
								<div class=" box-content">
									<div class="form-group">
									<div class="col-md-2">Order Month</div>
									<div class="col-md-3">
										<input class="form-control" id="Month" size="16" value="Month"
								  ...
								  document.getElementById("expExcel").disabled=false;
									document.getElementById('range').style.display = 'block';
												...
												var tr = $('<tr></tr>');
											  	...
											  	tr.append($('<td style="text-align:center;"></td>').html(itemList.month)); 
					...
					$('#loader').hide();
							 ...
							 function drawStuff() {
							  ...
							  // document.getElementById("chart_div").style.border = "thin dotted red";
						       ...
						       dataTable.addColumn('string', 'Month Wise'); // Implicit domain column.
						       dataTable.addColumn('number', 'Base Value'); // Implicit data column.
						       dataTable.addColumn('number', 'Total');
						       
						       var piedataTable = new google.visualization.DataTable();
						       piedataTable.addColumn('string', 'Month Wise'); // Implicit domain column.
