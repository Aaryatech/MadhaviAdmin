...
<c:url var="allRecordwithDate" value="/allRecordwithDate"></c:url>
	...
	<!-- 	 <div class="page-title">
			<div>
				<h1>
					<i class="fa fa-file-o"></i>Show All Store Material Receipt
				</h1>
		...
		<div class="box" id="pending">
			<div class="box-title">
				<h3>
					<i class="fa fa-bars"></i>Show All Store Material Receipt
					
				</h3>
				<div class="box-tool">
				<a  onclick="showdatewisetable()">Show Date wise All Record</a> 
				</div>
	...
	<div class="box" id="datewise_table" style="display: none">
			<div class="box-title">
				<h3>
					<i class="fa fa-bars"></i>Show All Store Material Receipt Date Wise
				</h3>
				<div class="box-tool">
