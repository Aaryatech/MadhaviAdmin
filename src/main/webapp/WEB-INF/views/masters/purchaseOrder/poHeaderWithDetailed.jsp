							...
							<table class="table table-bordered table-striped fill-head "
								...
								<c:forEach items="${purchaseOrderHeader.purchaseOrderDetail}" var="purchaseOrderDetailedList"
														...
														<tr>
															...
															<td style="text-align: right;"><c:out value="${purchaseOrderDetailedList.poQty}" /></td>


															<td style="text-align: right;"><c:out value="${purchaseOrderDetailedList.poRate}" /></td>
															<td style="text-align: right;"><c:out value="${purchaseOrderDetailedList.discPer}" /></td>
															<td style="text-align: right;"><c:out value="${purchaseOrderDetailedList.poQty*purchaseOrderDetailedList.poRate}" /></td>
															
															<td style="text-align: right;"><c:out value="${purchaseOrderDetailedList.schDays}" /></td>
