	...
	<div class="box" id="datewise_table" style="display: none">
			...
			<div class=" box-content"> 
						...
						<div class="form-group">
									...
									<div class="col-sm-5 col-lg-3 controls">
										<input class="form-control date-picker" value="${date}"  id="to_date" size="16"
				  ...
				  $.each(data,function(key, itemList) { 
									...
									var tr = $('<tr></tr>');  
								  	...
								  	if(itemList.status==1)
								  		{
								  		tr.append($('<td></td>').html('  <a href="${pageContext.request.contextPath}/materialReceiptDirectore?mrnId='+itemList.mrnId+'" class="action_btn" > <abbr title="Details"><i class="fa fa-list"></i></abbr></a>'));
