			...
			<div class="row">
				<div class="col-md-12">
					<div class="box">
						<div class="box-title">
							<h3>
								<i class="fa fa-bars"></i> Edit Instrument
							</h3>
							<div class="box-tool">
                        ...
                        <input type="hidden" name="instrument_id" id="instrument_id" value="${instrument.instrumentId}"/>
								<div class="form-group">
									...
									<div class="col-sm-9 col-lg-10 controls">
										<input type="text" name="instrument_name" id="instrument_name"
											...
											data-rule-required="true" value="${instrument.instrumentName}"/>
									</div>
								</div>
                                            <div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-9 col-lg-10 controls">
										<textarea name="instrument_status" id="instrument_status"
											...
											data-rule-required="true" >${instrument.instrumentStatus}</textarea>
									</div>
							  </div>
							  ...
							  <div class="form-group">
							   ...
							   <div class="form-group">
									...
									<div class="col-sm-9 col-lg-10 controls">
												<c:choose>
												<c:when test="${instrument.instrumentIsUsed==0}">
												<label class="radio-inline"> <input type="radio"
													...
													<c:when test="${instrument.instrumentIsUsed==1}">
													<label class="radio-inline"> <input type="radio"
