            ...
            <ul class="nav flaty-nav pull-right">
                ...
                <li class="hidden-xs">
                    ...
                    <ul class="dropdown-navbar dropdown-menu">
                        ...
                        <li class="notify">
                            <a href="#">
                                <img src="resources/img/demo/avatar/avatar2.jpg" alt="Alex" />
                ...
                <li class="hidden-xs">
                    ...
                    <ul class="dropdown-navbar dropdown-menu">
                        ...
                        <li class="msg">
                            <a href="#">
                                <img src="resources/img/demo/avatar/avatar3.jpg" alt="Sarah's Avatar" />
                                <div>
                        ...
                        <li class="msg">
                            <a href="#">
                                <img src="resources/img/demo/avatar/avatar4.jpg" alt="Emma's Avatar" />
                                <div>
                        ...
                        <li class="msg">
                            <a href="#">
                                <img src="resources/img/demo/avatar/avatar5.jpg" alt="John's Avatar" />
                                <div>
                ...
                <li class="user-profile">
                    <a data-toggle="dropdown" href="#" class="user-menu dropdown-toggle">
                        <img class="nav-user-photo" src="resources/img/demo/avatar/avatar1.jpg" alt="Penny's Photo" />
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="col-md-3 tile-active">
                                        <a class="tile tile-light-blue" data-stop="3000" href="http://codecanyon.net/item/flaty-wp-premium-wordpress-flat-admin-template/5329999">
                                            <div class="img img-center">
                                                <img src="resources/img/demo/wp-logo.png" />
                                            </div>
                      ...
                      <div class="tile tile-sml-blue">
                       ...
                       <div class="col-md-3 tile-active">
                        ...
                        <div class="col-md-3 tile-active">
                                ...
                                <div class="tile tile-green" data-stop="3500" style="background-image: url(resources/img/demo/gallery/5.jpg);">
                      ...
                      <div class="tile tile-light-magento">
                        ...
                        <div class="col-md-3 tile-active">
                                ...
                                <div class="tile tile-img" data-stop="3500" style="background-image: url(resources/img/demo/gallery/5.jpg);">
                                    <p class="title">Gallery</p>
                                </div>
