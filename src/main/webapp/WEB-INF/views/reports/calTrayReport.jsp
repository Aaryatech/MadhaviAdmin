...
<body onload="routListByDelType()">

	<jsp:include page="/WEB-INF/views/include/logout.jsp"></jsp:include>
	<c:url var="routListByDelType" value="/routListByDelType"></c:url>
	<c:url var="getBillList" value="/getPDispatchReportByRoute"></c:url>
	<c:url var="getMenuListBySectionId"
		value="/getMenuListBySectionIdForTray"></c:url>
	...
	<div id="main-content">
						...
						<div class="form-group">
							...
							<div class="col-sm-6 col-lg-4 controls">
								<select data-placeholder="Select Route" multiple="multiple"
									onchange="onChangeRoute(this.value)"
		...
		<script type="text/javascript">
			...
			function onChangeRoute(routeId) {

				if (routeId == 0) {
					var abcType = $("#abcType").val();
					if (abcType == "" || abcType == null) {
		...
		<script type="text/javascript">
			function genPdfNew() {
				...
				window
						.open('pdfForDisReport?url=pdf/getPDispatchReportNewPdf1/'
								+ date
								+ '/'
								+ stationId
								+ '/'
