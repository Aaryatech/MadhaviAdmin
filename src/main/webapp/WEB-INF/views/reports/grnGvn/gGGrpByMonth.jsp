...
<body>
	...
	<div id="main-content">
		...
		<!-- 	<div class="page-title">
			<div>
				<h1>
					<i class="fa fa-file-o"></i>Grn Gvn Report Group by Month
				</h1>
				<h4></h4>
			</div>
		</div> -->
 ...
 -->
	...
	<script type="text/javascript">
					...
					.getJSON(
							...
							function(data) {
								...
								function drawStuff() {
									...
									piedataTable.addColumn('string', 'Month'); // Implicit domain column.
		...
		function genPdf() {
			...
			var isGrn = $("#isGrn").val();
			window
					.open('${pageContext.request.contextPath}/pdfForReport?url=pdf/showGGreportGrpByMonth/'
							+ from_date
							+ '/'
							+ to_date
							+ '/'
