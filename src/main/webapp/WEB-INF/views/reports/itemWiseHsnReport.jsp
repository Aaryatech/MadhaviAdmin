...
<body>
	...
	<c:url var="getBillList" value="/getReportHSNItemwise"></c:url>
	...
	<div id="main-content">
		...
		<div class="page-title">
			<div>
				<h1>
					<i class="fa fa-file-o"></i>Item Wise Summary Report
				</h1>
				<h4></h4>
			</div>
		</div>
		...
		<div class="box">
			<div class="box-title">
				<h3>
					<i class="fa fa-bars"></i>View Item Wise Summary Report
				</h3>
				...
				<div class="row">
					...
					<div class="col-md-12" style="text-align: center;">
						...
						<button class="btn btn-primary" value="PDF" id="PDFButton"
							style="display: none;" onclick="genPdf()">PDF</button>
					</div>
		...
		<div class="box">
			<div class="box-title">
				<h3>
					<i class="fa fa-list-alt"></i>Item Wise Summary Report
				</h3>
		...
		function searchReport() {
...

			{
				...
				$.each(data, function(key, report) {
					...
					tr.append($('<td></td>').html(report.itemUom));
