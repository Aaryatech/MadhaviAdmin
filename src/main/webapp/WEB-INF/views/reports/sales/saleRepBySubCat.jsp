...
<body>
	...
	<c:url var="getBillList" value="/getSaleReportBySubCatAndFr"></c:url>
	...
	<div id="main-content">
		...
		<div class="page-title">
			<div>
				<h1>
					<i class="fa fa-file-o"></i>Franchisee SubCategory-wise Report
				</h1>
				<h4></h4>
			</div>
		</div>
		...
		<div class="box">
			<div class="box-title">
				<h3>
					<i class="fa fa-bars"></i> Franchisee SubCategory-wise Report
				</h3>
