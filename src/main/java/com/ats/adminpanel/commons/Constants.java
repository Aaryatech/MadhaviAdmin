...
public class Constants {
	...
	//public static final String url="http://97.74.228.55:8080/webapi/";
	...
	public static final String ReportURL ="http://97.74.228.55:8080/admin/";//change
	...
	public static final String REPORT_SAVE = "/opt/apache-tomcat-8.5.37/webapps/uploads/AdminReport.pdf";
	public static final String BILL_REPORT_PATH="/opt/apache-tomcat-8.5.37/webapps/uploads/Bill.pdf";
	public static final String CRN_REPORT_PATH="/opt/apache-tomcat-8.5.37/webapps/uploads/crn.pdf";
    public static final String FINISHEDGOOD_REPORT_PATH="/opt/apache-tomcat-8.5.37/webapps/uploads/fsr.pdf";
    public static final String PO_PDF_PATH="/opt/apache-tomcat-8.5.37/webapps/uploads/po.pdf";
    public static final String SALES_REPORT_PATH="/opt/apache-tomcat-8.5.37/webapps/uploads/report.pdf";
    public static final String INWARD_PATH="/opt/apache-tomcat-8.5.37/webapps/uploads/Inward.pdf";
    public static final String LOG_PDF_PATH="/opt/apache-tomcat-8.5.37/webapps/uploads/logdf.pdf";
    public static final String DISPATCH_PATH="/opt/apache-tomcat-8.5.37/webapps/uploads/dispatch.pdf";
		
	public static final String SP_CAKE_FOLDER = "http://97.74.228.55:8080/uploads/SPCAKE/";
	public static final String CUST_CHOICE_PHOTO_CAKE_FOLDER = "http://97.74.228.55:8080/uploads/CUSTCHOICEPHOTOCAKE/";
